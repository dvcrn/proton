...
return cljs.core.apply.call(null,(function (p1__10677_SHARP_){
return [cljs.core.str("<p>Keybindings:</p><ul class='flex-container'>"),cljs.core.str(p1__10677_SHARP_),cljs.core.str("</ul>")].join('');
...
proton.lib.helpers.process__GT_html = (function proton$lib$helpers$process__GT_html(steps){
var steps_html = cljs.core.map.call(null,(function (p1__10678_SHARP_){
return [cljs.core.str("<li class='process-step'>"),cljs.core.str(p1__10678_SHARP_),cljs.core.str("</li>")].join('');
}),steps);
return [cljs.core.str("<h2>Welcome to proton<h2><ul>"),cljs.core.str(clojure.string.join.call(null," ",steps_html)),cljs.core.str("</ul>")].join('');
});
